...
START_TEST(UA_Boolean_true_xml_encode) {
    ...
    *src = true;
    ...
    ck_assert_uint_eq(size,
        XML_ENCODE_BOOLEAN_TYPE_DEFINITION_LEN + booleanXmlSectLen + 4);
    ...
    char* result = XML_ENCODE_BOOLEAN_TYPE_DEFINITION
...
START_TEST(UA_Boolean_false_xml_encode) {
    ...
    *src = false;
    ...
    size_t size = UA_calcSizeXml((void*)src, type, NULL);
    ck_assert_uint_eq(size,
        XML_ENCODE_BOOLEAN_TYPE_DEFINITION_LEN + booleanXmlSectLen + 5);
...
START_TEST(UA_SByte_Max_Number_xml_encode) {
    ...
    char* result = XML_ENCODE_SBYTE_TYPE_DEFINITION
                   "<SByte>127</SByte>";
    buf.data[size] = 0; /* zero terminate */
    ck_assert_str_eq(result, (char*)buf.data);
...
START_TEST(UA_Byte_Max_Number_xml_encode) {
    ...
    *src = 255;
    ...
    char* result = XML_ENCODE_BYTE_TYPE_DEFINITION
                   "<Byte>255</Byte>";
    buf.data[size] = 0; /* zero terminate */
    ck_assert_str_eq(result, (char*)buf.data);
...
START_TEST(UA_Int16_Max_Number_xml_encode) {
    ...
    *src = 32767;
    ...
    char* result = XML_ENCODE_INT16_TYPE_DEFINITION
                   "<Int16>32767</Int16>";
    buf.data[size] = 0; /* zero terminate */
    ck_assert_str_eq(result, (char*)buf.data);
...
START_TEST(UA_UInt16_Max_Number_xml_encode) {
    ...
    *src = 65535;
    ...
    char* result = XML_ENCODE_UINT16_TYPE_DEFINITION
                   "<UInt16>65535</UInt16>";
    buf.data[size] = 0; /* zero terminate */
    ck_assert_str_eq(result, (char*)buf.data);
...
START_TEST(UA_Int32_Max_Number_xml_encode) {
    ...
    *src = 2147483647;
    ...
    char* result = XML_ENCODE_INT32_TYPE_DEFINITION
...
START_TEST(UA_UInt32_Max_Number_xml_encode) {
    ...
    *src = 4294967295;
    ...
    char* result = XML_ENCODE_UINT32_TYPE_DEFINITION
...
START_TEST(UA_Int64_Max_Number_xml_encode) {
    ...
    *src = 9223372036854775807LL;
    ...
    char* result = XML_ENCODE_INT64_TYPE_DEFINITION
...
START_TEST(UA_UInt64_Max_Number_xml_encode) {
    ...
    *src = 18446744073709551615ULL;
    ...
    char* result = XML_ENCODE_UINT64_TYPE_DEFINITION
...
START_TEST(UA_Float_xml_encode) {
    ...
    char* result = XML_ENCODE_FLOAT_TYPE_DEFINITION
                   "<Float>1</Float>";
    buf.data[size] = 0; /* zero terminate */
    ck_assert_str_eq(result, (char*)buf.data);
...
START_TEST(UA_Double_xml_encode) {
    ...
    char* result = XML_ENCODE_DOUBLE_TYPE_DEFINITION
...
START_TEST(UA_String_xml_encode) {
    ...
    char* result = XML_ENCODE_STRING_TYPE_DEFINITION
                   "<String>hello</String>";
    buf.data[size] = 0; /* zero terminate */
    ck_assert_str_eq(result, (char*)buf.data);
...
START_TEST(UA_DateTime_xml_encode) {
    ...
    *src = UA_DateTime_fromUnixTime(1234567);
    ...
    char* result = XML_ENCODE_DATETIME_TYPE_DEFINITION
...
START_TEST(UA_Guid_xml_encode) {
    ...
    size_t size = UA_calcSizeXml((void*)&src, type, NULL);
    ck_assert_uint_eq(size,
        XML_ENCODE_GUID_TYPE_DEFINITION_LEN + guidXmlSectLen + 36);
    ...
    char* result = XML_ENCODE_GUID_TYPE_DEFINITION
                   "<Guid>"
...
START_TEST(UA_ByteString_xml_encode) {
    ...
    *src = UA_BYTESTRING_ALLOC("asdfasdf");
    ...
    char* result = XML_ENCODE_BYTESTRING_TYPE_DEFINITION
...
START_TEST(UA_ByteString3_xml_encode) {
    ...
    *src = UA_BYTESTRING_ALLOC("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor "
    ...
    in = UA_BYTESTRING_ALLOC((const char*)&buf.data[XML_ENCODE_BYTESTRING_TYPE_DEFINITION_LEN]);
...
START_TEST(UA_NodeId_Numeric_xml_encode) {
    ...
    *src = UA_NODEID_NUMERIC(0, 5555);
    ...
    char* result = XML_ENCODE_NODEID_TYPE_DEFINITION
                   "<NodeId>"
...
START_TEST(UA_NodeId_Guid_Namespace_xml_encode) {
    ...
    *src = UA_NODEID_GUID(5, g);
    ...
    size_t size = UA_calcSizeXml((void*)src, type, NULL);
    ck_assert_uint_eq(size,
        XML_ENCODE_NODEID_TYPE_DEFINITION_LEN + nodeIdXmlSectLen + 43);
...
START_TEST(UA_NodeId_ByteString_xml_encode) {
    ...
    *src = UA_NODEID_BYTESTRING_ALLOC(0, "asdfasdf");
    ...
    size_t size = UA_calcSizeXml((void*)src, type, NULL);
    ck_assert_uint_eq(size,
        XML_ENCODE_NODEID_TYPE_DEFINITION_LEN + nodeIdXmlSectLen + 14);
...
START_TEST(UA_ExpandedNodeId_xml_encode) {
    ...
    *src = UA_EXPANDEDNODEID_STRING_ALLOC(23, "testtestTest");
    ...
    char* result = XML_ENCODE_EXPANDEDNODEID_TYPE_DEFINITION
                   "<ExpandedNodeId>"
...
START_TEST(UA_StatusCode_xml_encode) {
    ...
    *src = UA_STATUSCODE_BADAGGREGATECONFIGURATIONREJECTED;
    ...
    size_t size = UA_calcSizeXml((void*)src, type, NULL);
    ck_assert_uint_eq(size,
        XML_ENCODE_STATUSCODE_TYPE_DEFINITION_LEN + statusCodeXmlSectLen + 10);
    ...
    char* result = XML_ENCODE_STATUSCODE_TYPE_DEFINITION
                   "<StatusCode>"
...
START_TEST(UA_QualifiedName_xml_encode_1) {
    ...
    char* result = XML_ENCODE_QUALIFIEDNAME_TYPE_DEFINITION
                   "<QualifiedName>"
...
START_TEST(UA_LocalizedText_xml_encode) {
    ...
    char* result = XML_ENCODE_LOCALIZEDTEXT_TYPE_DEFINITION
                   "<LocalizedText>"
                     "<Locale>en</Locale>"
                     "<Text>enabled</Text>"
                   "</LocalizedText>";
